...
async function openInvoice() {
  // let done = document.getElementById("done")
    ...
    if (userInvoices.status === 1) {
      ...
      <table class="table table-borderless user-view-table m-0">
        <tbody>
          ...
          <td>${userInvoices.message.level}</td>
        </tr>
        <tr>
        <td class="fw-semibold">Institution Type:</td>
        <td>${userInvoices.message.institution}</td>
      </tr>
        </tbody>
      </table>
      `)
      ...
      <tbody>
        ...
        <tr>
          <td class="fw-semibold">Secondary Certificate:</td>
    ...
    <tr>
      <td class="fw-bold">Jamb Certificate:</td>
      <td><a href="${userInvoices.message.jamb_cert}" class="btn btn-outline-primary">View</a></td>
    </tr>
    <tr>
      <td class="fw-bold">School ID:</td>
      <td><a href="${userInvoices.message.school_id}" class="btn btn-outline-primary">View</a></td>
    </tr>
        <tr>
